...
3. [delete-repo](./delete-repo.sh): *WARNING*: This is a dangerous script. It deleted a single repository. It will delete both your local AND remote copies. Use at your own risk.